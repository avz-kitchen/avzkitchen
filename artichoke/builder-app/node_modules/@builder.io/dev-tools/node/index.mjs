...
`,++e,d===13&&s.charCodeAt(e)===10&&++e,++r,h=t=e):n.unterminated(a,o,l):++e}return{pos:e,str:c,firstInvalidLoc:u,lineStart:t,curLine:r,containsInvalid:!!u}}function Co(i,s,e,t){return i==="template"?s===96||s===36&&e.charCodeAt(t+1)===123:s===(i==="double"?34:39)}function Io(i,s,e,t,r,n){let a=!r;s++;let o=c=>({pos:s,ch:c,lineStart:e,curLine:t}),l=i.charCodeAt(s++);switch(l){case 110:return o(`
...
}`]);case"ModuleDeclaration":return r.push("module",i.call(e,"id")),t.source?r.push("from",i.call(e,"source")):r.push(i.call(e,"body")),S(" ").join(r);case"ImportSpecifier":return t.importKind&&t.importKind!=="value"&&r.push(t.importKind+" "),t.imported?(r.push(i.call(e,"imported")),t.local&&t.local.name!==t.imported.name&&r.push(" as ",i.call(e,"local"))):t.id&&(r.push(i.call(e,"id")),t.name&&r.push(" as ",i.call(e,"name"))),x(r);case"ExportSpecifier":return t.exportKind&&t.exportKind!=="value"&&r.push(t.exportKind+" "),t.local?(r.push(i.call(e,"local")),t.exported&&t.exported.name!==t.local.name&&r.push(" as ",i.call(e,"exported"))):t.id&&(r.push(i.call(e,"id")),t.name&&r.push(" as ",i.call(e,"name"))),x(r);case"ExportBatchSpecifier":return S("*");case"ImportNamespaceSpecifier":return r.push("* as "),t.local?r.push(i.call(e,"local")):t.id&&r.push(i.call(e,"id")),x(r);case"ImportDefaultSpecifier":return t.local?i.call(e,"local"):i.call(e,"id");case"TSExportAssignment":return x(["export = ",i.call(e,"expression")]);case"ExportDeclaration":case"ExportDefaultDeclaration":case"ExportNamedDeclaration":return fn(i,s,e);case"ExportAllDeclaration":return r.push("export *"),t.exported&&r.push(" as ",i.call(e,"exported")),r.push(" from ",i.call(e,"source"),";"),x(r);case"TSNamespaceExportDeclaration":return r.push("export as namespace ",i.call(e,"id")),ps(x(r));case"ExportNamespaceSpecifier":return x(["* as ",i.call(e,"exported")]);case"ExportDefaultSpecifier":return i.call(e,"exported");case"Import":return S("import",s);case"ImportExpression":return x(["import(",i.call(e,"source"),")"]);case"ImportDeclaration":{if(r.push("import "),t.importKind&&t.importKind!=="value"&&r.push(t.importKind+" "),t.specifiers&&t.specifiers.length>0){let n=[],a=[];if(i.each(function(o){let l=o.getValue();l.type==="ImportSpecifier"?a.push(e(o)):(l.type==="ImportDefaultSpecifier"||l.type==="ImportNamespaceSpecifier")&&n.push(e(o))},"specifiers"),n.forEach((o,l)=>{l>0&&r.push(", "),r.push(o)}),a.length>0){let o=S(", ").join(a);o.getLineLength(1)>s.wrapColumn&&(o=x([S(`,
`).join(a).indent(s.tabWidth),","])),n.length>0&&r.push(", "),o.length>1?r.push(`{
`,o,`
}`):s.objectCurlySpacing?r.push("{ ",o," }"):r.push("{",o,"}")}r.push(" from ")}return r.push(i.call(e,"source"),Wn(i,s,e),";"),x(r)}case"ImportAttribute":return x([i.call(e,"key"),": ",i.call(e,"value")]);case"StaticBlock":r.push("static ");case"BlockStatement":{let n=i.call(a=>ut(a,s,e),"body");return n.isEmpty()&&(!t.directives||t.directives.length===0)?(r.push("{}"),x(r)):(r.push(`{
`),t.directives&&i.each(function(a){r.push(ps(e(a).indent(s.tabWidth)),t.directives.length>1||!n.isEmpty()?`
...
`:`
`)),l=!P):(c!==1&&n||!u&&Bt(s,"objects")&&y.getValue().type!=="RestElement")&&r.push(a),p++},g)}),t.inexact){let g=S("...",s);u?(c>0&&r.push(a," "),r.push(g)):r.push(`
`,g.indent(s.tabWidth))}return r.push(u?f:`
`+f),p!==0&&u&&s.objectCurlySpacing&&(r[d]=h+" ",r[r.length-1]=" "+f),t.typeAnnotation&&r.push(i.call(e,"typeAnnotation")),x(r)}case"PropertyPattern":return x([i.call(e,"key"),": ",i.call(e,"pattern")]);case"ObjectProperty":case"Property":{if(t.method||t.kind==="get"||t.kind==="set")return Er(i,s,e);if(t.shorthand&&t.value.type==="AssignmentPattern")return i.call(e,"value");let n=i.call(e,"key");return t.computed?r.push("[",n,"]"):r.push(n),(!t.shorthand||t.key.name!==t.value.name)&&r.push(": ",i.call(e,"value")),x(r)}case"ClassMethod":case"ObjectMethod":case"ClassPrivateMethod":case"TSDeclareMethod":return Er(i,s,e);case"PrivateName":return x(["#",i.call(e,"id")]);case"Decorator":return x(["@",i.call(e,"expression")]);case"TupleExpression":r.push("#");case"ArrayExpression":case"ArrayPattern":{let a=t.elements.length,o=i.map(e,"elements"),c=S(", ").join(o).getLineLength(1)<=s.wrapColumn;return c?s.arrayBracketSpacing?r.push("[ "):r.push("["):r.push(`[
`),i.each(function(u){let h=u.getName();if(!u.getValue())r.push(",");else{let d=o[h];c?h>0&&r.push(" "):d=d.indent(s.tabWidth),r.push(d),(h<a-1||!c&&Bt(s,"arrays"))&&r.push(","),c||r.push(`
`)}},"elements"),c&&s.arrayBracketSpacing?r.push(" ]"):r.push("]"),t.typeAnnotation&&r.push(i.call(e,"typeAnnotation")),x(r)}case"SequenceExpression":return S(", ").join(i.map(e,"expressions"));case"ThisExpression":return S("this");case"Super":return S("super");case"NullLiteral":return S("null");case"RegExpLiteral":return S(ht(t)||`/${t.pattern}/${t.flags||""}`,s);case"BigIntLiteral":return S(ht(t)||t.value+"n",s);case"NumericLiteral":return S(ht(t)||t.value,s);case"DecimalLiteral":return S(ht(t)||t.value+"m",s);case"StringLiteral":return S(Ot(t.value,s));case"BooleanLiteral":case"Literal":return S(ht(t)||(typeof t.value=="string"?Ot(t.value,s):t.value),s);case"Directive":return i.call(e,"value");case"DirectiveLiteral":return S(ht(t)||Ot(t.value,s),s);case"InterpreterDirective":return S(`#!${t.value}
`,s);case"ModuleSpecifier":if(t.local)throw new Error("The ESTree ModuleSpecifier type should be abstract");return S(Ot(t.value,s),s);case"UnaryExpression":return r.push(t.operator),/[a-z]$/.test(t.operator)&&r.push(" "),r.push(i.call(e,"argument")),x(r);case"UpdateExpression":return r.push(i.call(e,"argument"),t.operator),t.prefix&&r.reverse(),x(r);case"ConditionalExpression":return x([i.call(e,"test")," ? ",i.call(e,"consequent")," : ",i.call(e,"alternate")]);case"NewExpression":return r.push("new ",i.call(e,"callee")),t.typeParameters&&r.push(i.call(e,"typeParameters")),t.typeArguments&&r.push(i.call(e,"typeArguments")),t.arguments&&r.push(pn(i,s,e)),x(r);case"VariableDeclaration":{t.declare&&r.push("declare "),r.push(t.kind," ");let n=0,a=i.map(function(l){let c=e(l);return n=Math.max(c.length,n),c},"declarations");n===1?r.push(S(", ").join(a)):a.length>1?r.push(S(`,
`).join(a).indentTail(t.kind.length+1)):r.push(a[0]);let o=i.getParentNode();return!Y.ForStatement.check(o)&&!Y.ForInStatement.check(o)&&!(Y.ForOfStatement&&Y.ForOfStatement.check(o))&&!(Y.ForAwaitStatement&&Y.ForAwaitStatement.check(o))&&r.push(";"),x(r)}case"VariableDeclarator":return t.init?S(" = ").join([i.call(e,"id"),i.call(e,"init")]):i.call(e,"id");case"WithStatement":return x(["with (",i.call(e,"object"),") ",i.call(e,"body")]);case"IfStatement":{let n=Je(i.call(e,"consequent"),s);return r.push("if (",i.call(e,"test"),")",n),t.alternate&&r.push(dn(n)?" else":`
else`,Je(i.call(e,"alternate"),s)),x(r)}case"ForStatement":{let n=i.call(e,"init"),a=n.length>1?`;
`:"; ",o="for (",l=S(a).join([n,i.call(e,"test"),i.call(e,"update")]).indentTail(o.length),c=x([o,l,")"]),u=Je(i.call(e,"body"),s);return r.push(c),c.length>1&&(r.push(`
`),u=u.trimLeft()),r.push(u),x(r)}case"WhileStatement":return x(["while (",i.call(e,"test"),")",Je(i.call(e,"body"),s)]);case"ForInStatement":return x([t.each?"for each (":"for (",i.call(e,"left")," in ",i.call(e,"right"),")",Je(i.call(e,"body"),s)]);case"ForOfStatement":case"ForAwaitStatement":return r.push("for "),(t.await||t.type==="ForAwaitStatement")&&r.push("await "),r.push("(",i.call(e,"left")," of ",i.call(e,"right"),")",Je(i.call(e,"body"),s)),x(r);case"DoWhileStatement":{let n=x(["do",Je(i.call(e,"body"),s)]);return r.push(n),dn(n)?r.push(" while"):r.push(`
while`),r.push(" (",i.call(e,"test"),");"),x(r)}case"DoExpression":{let n=i.call(a=>ut(a,s,e),"body");return x([`do {
`,n.indent(s.tabWidth),`
...
`).join(i.map(e,"body").map(a=>Ut(a)!==";"?a.concat(";"):a));return n.isEmpty()?S("{}",s):x([`{
`,n.indent(s.tabWidth),`
}`])}case"TSImportType":return r.push("import(",i.call(e,"argument"),")"),t.qualifier&&r.push(".",i.call(e,"qualifier")),t.typeParameters&&r.push(i.call(e,"typeParameters")),x(r);case"TSImportEqualsDeclaration":return t.isExport&&r.push("export "),r.push("import ",i.call(e,"id")," = ",i.call(e,"moduleReference")),ps(x(r));case"TSExternalModuleReference":return x(["require(",i.call(e,"expression"),")"]);case"TSModuleDeclaration":return i.getParentNode().type==="TSModuleDeclaration"?r.push("."):(t.declare&&r.push("declare "),t.global||(t.id.type==="StringLiteral"||t.id.type==="Literal"&&typeof t.id.value=="string"||t.loc&&t.loc.lines&&t.id.loc&&t.loc.lines.sliceString(t.loc.start,t.id.loc.start).indexOf("module")>=0?r.push("module "):r.push("namespace "))),r.push(i.call(e,"id")),t.body&&(r.push(" "),r.push(i.call(e,"body"))),x(r);case"TSModuleBlock":{let n=i.call(a=>ut(a,s,e),"body");return n.isEmpty()?r.push("{}"):r.push(`{
`,n.indent(s.tabWidth),`
}`),x(r)}case"TSInstantiationExpression":return r.push(i.call(e,"expression"),i.call(e,"typeParameters")),x(r);case"V8IntrinsicIdentifier":return x(["%",i.call(e,"name")]);case"TopicReference":return S("#");case"ClassHeritage":case"ComprehensionBlock":case"ComprehensionExpression":case"Glob":case"GeneratorExpression":case"LetStatement":case"LetExpression":case"GraphExpression":case"GraphIndexExpression":case"XMLDefaultDeclaration":case"XMLAnyName":case"XMLQualifiedIdentifier":case"XMLFunctionQualifiedIdentifier":case"XMLAttributeSelector":case"XMLFilterExpression":case"XML":case"XMLElement":case"XMLList":case"XMLEscape":case"XMLText":case"XMLStartTag":case"XMLEndTag":case"XMLPointTag":case"XMLName":case"XMLAttribute":case"XMLCdata":case"XMLComment":case"XMLProcessingInstruction":default:debugger;throw new Error("unknown type: "+JSON.stringify(t.type))}}function mc(i,s){let e=[],t=i.getValue();return t.decorators&&t.decorators.length>0&&!In(i)?i.each(function(r){e.push(s(r),`
`)},"decorators"):Ps(t)&&t.declaration&&t.declaration.decorators&&i.each(function(r){e.push(s(r),`
`)},"declaration","decorators"),x(e)}function ut(i,s,e){let t=[];i.each(function(o){let l=o.getValue();l&&(l.type==="EmptyStatement"&&!(l.comments&&l.comments.length>0)||(Y.Comment.check(l)||Y.Statement.check(l)||Ur.assert(l),t.push({node:l,printed:e(o)})))});let r=null,n=t.length,a=[];return t.forEach(function(o,l){let c=o.printed,u=o.node,h=c.length>1,f=l>0,d=l<n-1,p,g,y=u&&u.loc&&u.loc.lines,b=y&&s.reuseWhitespace&&Cn(u,y);if(f)if(b){let P=y.skipSpaces(b.start,!0),k=P?P.line:1,T=b.start.line-k;p=Array(T+1).join(`
`)}else p=h?`
...
`:`
`;else g="";a.push(yc(r,p),c),d?r=g:g&&a.push(g)}),x(a)}function yc(i,s){if(!i&&!s)return S("");if(!i)return S(s);if(!s)return S(i);let e=S(i),t=S(s);return t.length>e.length?t:e}function zn(i){let s=[];i.declare&&s.push("declare ");let e=i.accessibility||i.access;return typeof e=="string"&&s.push(e," "),i.static&&s.push("static "),i.override&&s.push("override "),i.abstract&&s.push("abstract "),i.readonly&&s.push("readonly "),s}function Er(i,s,e){let t=i.getNode(),r=t.kind,n=[],a=t.value;Y.FunctionExpression.check(a)||(a=t),n.push(...zn(t)),a.async&&n.push("async "),a.generator&&n.push("*"),(r==="get"||r==="set")&&n.push(r," ");let o=i.call(e,"key");return t.computed&&(o=x(["[",o,"]"])),n.push(o),t.optional&&n.push("?"),t===a?(n.push(i.call(e,"typeParameters"),"(",Ce(i,s,e),")",i.call(e,"returnType")),t.body?n.push(" ",i.call(e,"body")):n.push(";")):(n.push(i.call(e,"value","typeParameters"),"(",i.call(l=>Ce(l,s,e),"value"),")",i.call(e,"value","returnType")),a.body?n.push(" ",i.call(e,"value","body")):n.push(";")),x(n)}function pn(i,s,e){let t=i.map(e,"arguments"),r=Bt(s,"parameters"),n=S(", ").join(t);return n.getLineLength(1)>s.wrapColumn?(n=S(`,
`).join(t),x([`(
...
`).join(n),Bt(s,"parameters")&&!t.rest&&r[r.length-1].type!=="RestElement"?a=x([a,`,
`]):a=x([a,`
`]),x([`
`,a.indent(s.tabWidth)])):a}function Wn(i,s,e){let t=i.getValue();if(t.assertions&&t.assertions.length>0){let r=[" assert {"],n=i.map(e,"assertions"),a=S(", ").join(n);return a.length>1||a.getLineLength(1)>s.wrapColumn?r.push(`
`,S(`,
`).join(n).indent(s.tabWidth),`
}`):r.push(" ",a," }"),x(r)}return S("")}function fn(i,s,e){let t=i.getValue(),r=["export "];t.exportKind&&t.exportKind==="type"&&(t.declaration||r.push("type "));let n=s.objectCurlySpacing;if(Y.Declaration.assert(t),(t.default||t.type==="ExportDefaultDeclaration")&&r.push("default "),t.declaration)r.push(i.call(e,"declaration"));else if(t.specifiers){if(t.specifiers.length===1&&t.specifiers[0].type==="ExportBatchSpecifier")r.push("*");else if(t.specifiers.length===0)r.push("{}");else if(t.specifiers[0].type==="ExportDefaultSpecifier"){let o=[],l=[];if(i.each(function(c){c.getValue().type==="ExportDefaultSpecifier"?o.push(e(c)):l.push(e(c))},"specifiers"),o.forEach((c,u)=>{u>0&&r.push(", "),r.push(c)}),l.length>0){let c=S(", ").join(l);c.getLineLength(1)>s.wrapColumn&&(c=x([S(`,
`).join(l).indent(s.tabWidth),","])),o.length>0&&r.push(", "),c.length>1?r.push(`{
`,c,`
}`):s.objectCurlySpacing?r.push("{ ",c," }"):r.push("{",c,"}")}}else r.push(n?"{ ":"{",S(", ").join(i.map(e,"specifiers")),n?" }":"}");t.source&&r.push(" from ",i.call(e,"source"),Wn(i,s,e))}let a=x(r);return Ut(a)!==";"&&!(t.declaration&&(t.declaration.type==="FunctionDeclaration"||t.declaration.type==="ClassDeclaration"||t.declaration.type==="TSModuleDeclaration"||t.declaration.type==="TSInterfaceDeclaration"||t.declaration.type==="TSEnumDeclaration"))&&(a=x([a,";"])),a}function Lt(i,s){return In(i)||s.unshift("declare "),x(s)}function Dt(i,s){return i.call(function(e){let t=e.getValue();return t?t==="plus"?S("+"):t==="minus"?S("-"):s(e):S("")},"variance")}function Je(i,s){return i.length>1?x([" ",i]):x([`
`,ps(i).indent(s.tabWidth)])}function Ut(i){let s=i.lastPos();do{let e=i.charAt(s);if(/\S/.test(e))return e}while(i.prevPos(s))}function dn(i){return Ut(i)==="}"}function os(i){return i.replace(/['"]/g,s=>s==='"'?"'":'"')}function ht(i){let s=Be(i,"value"),e=Be(i,"extra");if(e&&typeof e.raw=="string"&&s==e.rawValue)return e.raw;if(i.type==="Literal"){let t=i.raw;if(typeof t=="string"&&s==t)return t}}function ls(i){return JSON.stringify(i).replace(/[\u2028\u2029]/g,function(s){return"\\u"+s.charCodeAt(0).toString(16)})}function Ot(i,s){switch(Ur.assert(i),s.quote){case"auto":{let e=ls(i),t=os(ls(os(i)));return e.length>t.length?t:e}case"single":return os(ls(os(i)));case"double":default:return ls(i)}}function ps(i){let s=Ut(i);return!s||`
};`.indexOf(s)<0?x([i,";"]):i}function gc(i,s){return new fc(s).print(i)}var cs;function Jn(){if(cs)return cs;let i=xc();return cs={parse(s,e){return yn.parse(s,{...i,...e})}},cs}function xc(){return{sourceType:"module",strictMode:!1,allowImportExportEverywhere:!0,allowReturnOutsideFunction:!0,startLine:1,tokens:!0,plugins:["asyncGenerators","bigInt","classPrivateMethods","classPrivateProperties","classProperties","classStaticBlock","decimal","decorators-legacy","doExpressions","dynamicImport","exportDefaultFrom","exportExtensions","exportNamespaceFrom","functionBind","functionSent","importAssertions","importMeta","nullishCoalescingOperator","numericSeparator","objectRestSpread","optionalCatchBinding","optionalChaining",["pipelineOperator",{proposal:"minimal"}],["recordAndTuple",{syntaxType:"hash"}],"throwExpressions","topLevelAwait","v8intrinsic","jsx","typescript"]}}var bc=Object.defineProperty,Tc=(i,s,e)=>s in i?bc(i,s,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[s]=e,mn=(i,s,e)=>(Tc(i,typeof s!="symbol"?s+"":s,e),e),se=class extends Error{constructor(s,e){if(super(""),mn(this,"rawMessage"),mn(this,"options"),this.name="MagicastError",this.rawMessage=s,this.options=e,e?.ast&&e?.code&&e.ast.loc){let{line:t,column:r}=e.ast.loc.start,n=e.code.split(`
